...
// Create the Transport
	$transport = (new Swift_SmtpTransport('smtp.gmail.com', 587,'tls'))
	  ->setUsername('tapotoshghosh@gmail.com')
  	  ->setPassword('tapu_soma1996')
		;
...
// Create a message
	$message = (new Swift_Message('Verification Code'))
  	->setFrom(['tapotoshghosh@gmail.com' => 'Encryptech'])
  	->setTo([$c_email => $c_name])
  	->setBody($code)
  		;
...
$run_cust=mysqli_query($con,$s);
         echo "<script>alert('You have been Registered Sucessfully...Please check your email and insert your email & code to complete registration')</script>";
