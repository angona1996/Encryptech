...
$db = mysqli_connect("localhost","root","","encryptechfinal");
...
function add_cart(){
    ...
    if(isset($_GET['add_cart'])){
        ...
        $v="select * from products where product_id='$p_id' ";
        ...
        {
            echo "<script>alert('This product is stocked out')</script>";
...
function getPro(){
    ...
    while($row_products=mysqli_fetch_array($run_products)){
        ...
        <div class='col-md-4 col-sm-6 single'>
            ...
            <div class='product' style='height:400px ; width:250px' >
                                        
                                            
                                            <div style='height:200px ; width:250px'>
                                              <center>
                                              <a href='details.php?pro_id=$pro_id'>  
                                                <img height = '200px' width = '250px'  src='admin_area/product_images/$pro_img1' >
                                                </a>
                                                </center>
                                            </div>
