...
function project_function() // script function for  Web Functional Tester project NewProject3
{
	...
	var group = webtest.addActionGroup('NewProject3_ActionGroup1', IWebGroup.GROUP_HTTP);
	...
	group.setProxyWhileReplaying(true);
	var group = webtest.addActionGroup('NewProject3_ActionGroup2', IWebGroup.GROUP_HTTP);
...
function group_1() // script function for NewProject3_ActionGroup1
{
	executeBrowser_1();
	executeEvent_2();
}
...
function group_2() // script function for NewProject3_ActionGroup2
{
	executeBrowser_3();
	executeEvent_4();
}
