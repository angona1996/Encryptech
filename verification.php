               ...
               <div class="box"><!-- box Begin -->
                   ...
                   <div class="box-header"><!-- box-header Begin -->
                       ...
                       <center><!-- center Begin -->
                           ...
                           <h5>Enter Email & click Resend Code to generate new code</h5>
                           
                       </center><!-- center Finish -->
                       
                       <form action="verification.php" method="post" enctype="multipart/form-data"><!-- form Begin -->
                           ...
                           <div class="text-center"><!-- text-center Begin -->
                               ...
                               <i class="fa fa-user-md"></i> Verify Account
                               
                               </button>
                               
                               <button type="submit" name="resend" class="btn btn-primary">
                               
                               <i class="fa fa-user-md"></i> Resend Code
...
//send email
    ...
    $code  = md5($code);
     ...
     $insert_customer = "update customers set code = '$code' where customer_email = '$c_email' ";  
    $run_customer = mysqli_query($con,$insert_customer);
        echo "<script>alert('A new verification code is send to your email')</script>";
        header('Location: '.$_SERVER['PHP_SELF']);
        die;
